...
public class EffectiveMetamodelReconciler {
	...
	protected ArrayList<SmartEMF> effectiveMetamodels = new ArrayList<SmartEMF>();
	...
	public ArrayList<SmartEMF> getEffectiveMetamodels() {
		return effectiveMetamodels;
	}
	
	public void addEffectiveMetamodel(SmartEMF effectiveMetamodel)
	{
		effectiveMetamodels.add(effectiveMetamodel);
	}
	
	public void addEffectiveMetamodels(ArrayList<SmartEMF> effectiveMetamodels)
	{
	...
	public void reconcile()
	{
		...
		for(SmartEMF em: effectiveMetamodels)
		{
	...
	public void insertPlaceHolderOjbects(EPackage ePackage, EClass eClass)
	{
		...
		if (!inserted) {
			addPlaceHolderObject(ePackage.getName(), eClass.getName());
			SmartEMF newEffectiveMetamodel = new SmartEMF();
